...
# 使用 Streamlit 的缓存功能，避免每次刷新都去请求谷歌，提升网页速度（缓存10分钟）
...
if not master_data.empty and 'Material' in master_data.columns:
    ...
    st.sidebar.warning("Could not sync data. Please check your Google Sheet.")
...
with tab1:
    if not master_data.empty:
        ...
        st.info("Loading data or database is empty.")

# ==========================================
# TAB 3: Data Management (管理中心)
# ==========================================
with tab3:
    st.subheader("Database Connection Status")
    st.success("✅ Connected to Google Sheets Database successfully.")
